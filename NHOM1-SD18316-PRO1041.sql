...
-- Insert into HoaDon
INSERT INTO HoaDon (MaHD, NgayTao, NgayThanhToan, TongTien, TienGiam, TienDua, TienThua, TrangThai, IdNV, IdKM, GhiChu, IdKH,hinhThucTT)
VALUES			('HD001', '2023-11-26', '2023-11-27', 7000000, 70000, 7000000, 70000, 1, 1, 1, N'Đơn hàng số 1', 1 ,N'Tiền mặt'),
				('HD002', '2023-11-27', '2023-11-28', 4500000, 150000, 4350000, 0, 1, 2, 2, N'Đơn hàng số 2', 2,N'Chuyển khoản'),
				('HD003', '2023-11-28', '2023-11-29', 3000000, 50000, 3000000, 50000, 2, 3, 3, N'Đơn hàng số 3', 3,N'Kết hợp'),
				('HD004', '2023-11-29', '2023-11-30', 3500000, 200000, 3300000, 0, 2, 4, 1, N'Đơn hàng số 4', 4,N'Tiền mặt'),
				('HD005', '2022-12-01', '2022-12-02', 4000000, 100000, 3900000, 0, 1, 5, 1, N'Đơn hàng số 5', 6,N'Tiền mặt'),
				('HD006', '2022-12-02', '2022-12-03', 5500000, 150000, 5350000, 0, 1, 4, 2, N'Đơn hàng số 6', 7,N'Chuyển khoản'),
				('HD007', '2022-12-03', '2022-12-04', 6500000, 200000, 6300000, 0, 2, 3, 3, N'Đơn hàng số 7', 8,N'Tiền mặt'),
				('HD008', '2022-12-04', '2022-12-05', 3000000, 50000, 3000000, 50000, 2, 2, 4, N'Đơn hàng số 8', 9,N'Tiền mặt'),
				('HD009', '2022-12-05', '2022-12-06', 4500000, 90000, 4410000, 0, 3, 1, 1, N'Đơn hàng số 9', 10,N'Chuyển khoản'),
				('HD010', '2022-12-06', '2022-12-07', 5000000, 100000, 4900000, 0, 1, 2, 2, N'Đơn hàng số 10', 11,N'Kết hợp'),
				('HD011', '2022-12-07', '2022-12-08', 6000000, 120000, 5880000, 0, 2, 4, 2, N'Đơn hàng số 11', 12,N'Tiền mặt'),
				('HD012', '2022-12-08', '2022-12-09', 4500000, 90000, 4410000, 0, 3, 3, 3, N'Đơn hàng số 12', 13,N'Chuyển khoản'),
				('HD013', '2022-12-09', '2022-12-10', 3000000, 50000, 3000000, 50000, 1, 5, 4, N'Đơn hàng số 13', 14,N'Tiền mặt'),
				('HD014', '2022-12-10', '2022-12-11', 3500000, 200000, 3300000, 0, 2, 4, 1, N'Đơn hàng số 14', 15,N'Tiền mặt'),
				('HD015', '2022-12-11', '2022-12-12', 7000000, 70000, 7000000, 70000, 1, 1, 1, N'Đơn hàng số 15', 16,N'Tiền mặt'),
				('HD016', '2022-12-12', '2022-12-13', 4500000, 90000, 4410000, 0, 3, 2, 2, N'Đơn hàng số 16', 17,N'Tiền mặt'),
				('HD017', '2022-12-13', '2022-12-14', 3000000, 50000, 3000000, 50000, 2, 3, 3, N'Đơn hàng số 17', 18,N'Tiền mặt'),
				('HD018', '2022-12-14', '2022-12-15', 3500000, 200000, 3300000, 0, 1, 1, 1, N'Đơn hàng số 18', 19,N'Tiền mặt'),
				('HD019', '2022-12-15', '2022-12-16', 6000000, 120000, 5880000, 0, 2, 4, 2, N'Đơn hàng số 19', 20,N'Tiền mặt'),
				('HD021', '2023-12-16', '2023-12-17', 4000000, 200000, 3800000, 0, 8, 4, 1, N'Đơn hàng số 21', 1,N'Tiền mặt'),
				('HD022', '2023-12-17', '2023-12-18', 6000000, 100000, 5900000, 0, 9, 1, 2, N'Đơn hàng số 22', 2,N'Tiền mặt'),
				('HD023', '2023-12-18', '2023-12-19', 4500000, 50000, 4450000, 0, 9, 2, 3, N'Đơn hàng số 23', 3,N'Tiền mặt'),
				('HD024', '2023-12-19', '2023-12-20', 5500000, 200000, 5300000, 0, 10, 3, 1, N'Đơn hàng số 24', 4,N'Tiền mặt'),
				('HD025', '2023-12-20', '2023-12-21', 3000000, 100000, 2900000, 0, 10, 4, 2, N'Đơn hàng số 25', 5,N'Tiền mặt');
...
INSERT INTO GioHang (MaGioHang, IdHD)
VALUES ('GH001', 1),
       ('GH002', 2),
       ('GH003', 3),
       ('GH004', 4),
